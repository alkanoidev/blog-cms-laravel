<aside class="sidenav bg-gray-800 navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'create-new-post') == true ? 'active' : '' }}" href="{{ route('create-new-post') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" width="24px">
            ...
            <li class="nav-item">
                <form role="form" method="post" action="{{ route('logout') }}" id="logout-form">
                    ...
                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <div class="icon icon-shape text-white icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
