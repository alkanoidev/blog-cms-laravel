@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <span class="relative z-0 inline-flex shadow-sm rounded-md flex items-center gap-2">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span
                                class="bg-surface-light dark:bg-surface-dark shadow w-12 h-12
                                flex items-center justify-center p-3 rounded-full font-medium
                    ...
                    @else
                        <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                            <span
                                class="bg-surface-light dark:bg-surface-dark shadow w-full h-full w-12 h-12
                                flex items-center justify-center p-3 rounded-full font-medium
                                hover:bg-primary-light dark:hover:bg-primary-dark
                                hover:bg-opacity-[12%] dark:hover:bg-opacity-[12%]
                                focus:bg-primary-light dark:focus:bg-primary-dark
